namespace uppercut.tests.template.builder.settings
{
    ...
    <property name=""server.database"" value=""dbprodserver"" />
    <property name=""server.app"" value=""appprodserver"" />
    <property name=""server.queue"" value=""appprodserver"" />
    <property name=""server.files"" value=""appprodserver"" />
    <property name=""server.mtpubsub"" value=""appprodserver"" />
    ...
    <property name=""email.errors.to"" value=""someone@prod.com"" />
    
    <!-- A HOST -->
    <property name=""a.queue.name"" value=""aintegration"" />
    <property name=""a.bondservice.type"" value=""PRODBondService"" />
    <property name=""a.int.time_between_queries"" value=""3600"" />
    <property name=""a.int.trades_days_after_settlement"" value=""45"" />
    
    <!-- B HOST -->
    <property name=""a.b.bondservice.type"" value=""PRODBondService"" />
    <property name=""b.filewatch.interval"" value=""10"" />
    <property name=""b.queue.name"" value=""bintegration"" />
    <property name=""c.bondservice.type"" value=""PRODBondService"" />
    <property name=""c.swapservice.type"" value=""PRODSwapService"" />
    <property name=""c.discountnoteservice.type"" value=""PRODDiscountNoteService"" />
