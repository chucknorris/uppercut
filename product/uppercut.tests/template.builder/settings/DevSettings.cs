...
@"<project>
    ...
    <property name=""server.database"" value=""dbdevserver"" />
    <property name=""server.app"" value=""appdevserver"" />
    <property name=""server.queue"" value=""appdevserver"" />
    <property name=""server.files"" value=""appdevserver"" />
    <property name=""server.mtpubsub"" value=""appdevserver"" />
    ...
    <property name=""email.errors.to"" value=""someone@dev.com"" />
    
    <!-- A HOST -->
    <property name=""a.queue.name"" value=""aintegration"" />
    <property name=""a.bondservice.type"" value=""DEVBondService"" />
    <property name=""a.int.time_between_queries"" value=""3600"" />
    <property name=""a.int.trades_days_after_settlement"" value=""45"" />
    
    <!-- B HOST -->
    <property name=""a.b.bondservice.type"" value=""DEVBondService"" />
    <property name=""b.filewatch.interval"" value=""10"" />
    <property name=""b.queue.name"" value=""bintegration"" />
    <property name=""c.bondservice.type"" value=""DEVBondService"" />
    <property name=""c.swapservice.type"" value=""DEVSwapService"" />
    <property name=""c.discountnoteservice.type"" value=""DEVDiscountNoteService"" />
