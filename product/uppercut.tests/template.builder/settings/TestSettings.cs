namespace uppercut.tests.template.builder.settings
{
    ...
    <property name=""server.database"" value=""dbtestserver"" />
    <property name=""server.app"" value=""apptestserver"" />
    <property name=""server.queue"" value=""apptestserver"" />
    <property name=""server.files"" value=""apptestserver"" />
    <property name=""server.mtpubsub"" value=""apptestserver"" />
    ...
    <property name=""email.errors.to"" value=""someone@test.com"" />
    
    <!-- A HOST -->
    <property name=""a.queue.name"" value=""aintegration"" />
    <property name=""a.bondservice.type"" value=""TESTBondService"" />
    <property name=""a.int.time_between_queries"" value=""3600"" />
    <property name=""a.int.trades_days_after_settlement"" value=""45"" />
    
    <!-- B HOST -->
    <property name=""a.b.bondservice.type"" value=""TESTBondService"" />
    <property name=""b.filewatch.interval"" value=""10"" />
    <property name=""b.queue.name"" value=""bintegration"" />
    <property name=""c.bondservice.type"" value=""TESTBondService"" />
    <property name=""c.swapservice.type"" value=""TESTSwapService"" />
    <property name=""c.discountnoteservice.type"" value=""TESTDiscountNoteService"" />
