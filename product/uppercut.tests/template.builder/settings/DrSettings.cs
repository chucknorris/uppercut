namespace uppercut.tests.template.builder.settings
{
    public class DrSettings
    {
        public static string Contents =
            @"<project>
    <property name=""environment"" value=""DR"" />
    <property name=""server.database"" value=""dbdrserver"" />
    <property name=""server.app"" value=""appdrserver"" />
    <property name=""server.queue"" value=""appdrserver"" />
    <property name=""server.files"" value=""appdrserver"" />
    <property name=""server.mtpubsub"" value=""appdrserver"" />
    ...
    <property name=""email.errors.to"" value=""someone@dr.com"" />
    
    <!-- A HOST -->
    <property name=""a.queue.name"" value=""aintegration"" />
    <property name=""a.bondservice.type"" value=""DRBondService"" />
    <property name=""a.int.time_between_queries"" value=""3600"" />
    <property name=""a.int.trades_days_after_settlement"" value=""45"" />
    
    <!-- B HOST -->
    <property name=""a.b.bondservice.type"" value=""DRBondService"" />
    <property name=""b.filewatch.interval"" value=""10"" />
    <property name=""b.queue.name"" value=""bintegration"" />
    <property name=""c.bondservice.type"" value=""DRBondService"" />
    <property name=""c.swapservice.type"" value=""DRSwapService"" />
    <property name=""c.discountnoteservice.type"" value=""DRDiscountNoteService"" />
