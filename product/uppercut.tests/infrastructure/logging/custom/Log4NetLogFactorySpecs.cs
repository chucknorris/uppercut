namespace uppercut.tests.infrastructure.logging.custom
{
    using bdddoc.core;
    ...
    {
        public abstract class concern_for_Log4NetLogFactory : observations_for_a_sut_with_a_contract<ILogFactory, Log4NetLogFactory>
        {
        }
        ...
        public class when_creating_a_log4netfactory : concern_for_Log4NetLogFactory
        {
            ...
            [Observation]
            public void should_create_an_object_of_type_ILog()
            {
                result.should_be_an_instance_of<ILog>();
            }
        }
    }
}